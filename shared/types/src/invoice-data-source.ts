 ...
 * All valid statuses
 */
export const INVOICE_DATA_SOURCE_STATUSES: InvoiceDataSourceStatus[] = [
  'active',
  'paused',
  'archived',
];
 ...
 */
export const INVOICE_DATA_SOURCE_STATUS_LABELS: Record<InvoiceDataSourceStatus, string> = {
  active: 'Active',
  paused: 'Paused',
  archived: 'Archived',
};
 ...
 */
export type InvoiceDataSourceEventType =
  | 'email_received'
  | 'processing_started'
 ...
 * Log status values
 */
export type InvoiceDataSourceLogStatus =
  | 'received'
  | 'processing'
  | 'success'
  | 'failed'
