 ...
 */
export declare const VENDOR_SERVICES: VendorService[];
/**
 * Payment terms types
 */
export type PaymentTermsType = 'no_due_date' | 'based_on_invoice' | '14_days' | '30_days' | 'custom';
/**
 * Display labels for payment terms
 */
export declare const PAYMENT_TERMS_LABELS: Record<PaymentTermsType, string>;
/**
